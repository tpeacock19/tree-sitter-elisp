...
((symbol) @keyword
 (.match? @keyword "(defvar|defvar-local|defface|defcustom|defgroup)")
 .
 (symbol) @variable)

((symbol) @keyword
 (.match? @keyword "(defvar|defvar-local|defface|defcustom|defgroup|define-minor-mode)")
 .
 (symbol) @variable
 (string) @doc)
...
(list
 (symbol) @keyword
 (.match? @keyword "(flet|letf|flet*|letf*|let|let*)")
 .
...
;; Highlight the rest of functions
(["("]
 (list
  .
  (symbol) @function
